...
type RankCollectionListItemLoaderProps = {
  index: number;
};

const RankCollectionListItemLoader = ({ index }: RankCollectionListItemLoaderProps) => {
...
export default RankCollectionListItemLoader;
